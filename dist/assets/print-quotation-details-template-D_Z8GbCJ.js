import{r as g,de as z,e3 as $,j as r,B as u,S as R,I as y,aQ as C,d0 as A,d7 as P,ed as M,ee as v,h as Q,l as V,C as U,aU as _,ea as Y,e8 as G}from"./index-CC8ZOXtA.js";import{g as D,r as J,e as K}from"./utils-MBUcMVfY.js";import{u as F}from"./use-table-BFN1iUju.js";import{a as E,b as H,c as I,T as B}from"./table-head-custom-DVdNqcUm.js";import{T as O}from"./table-pagination-custom-BLNPouAz.js";import{T as N}from"./TextField-C3GBty_k.js";import{I as Z}from"./InputAdornment-CZqtpVU7.js";import{S as X}from"./Select-aQYZH3TH.js";import{T as w}from"./TableCell-Lyd9zWIr.js";import{T as W}from"./table-empty-rows-C8apdTaI.js";import{b as f}from"./format-number-pdBITjLa.js";const q=[{id:"orderNumber",label:"#",width:40,align:"center"},{id:"name",label:"Topic"},{id:"rate",label:"Date",width:200,align:"center"},{id:"totalAmount",label:"Status",width:80,align:"center"},{id:"status",label:"Priority",width:120,align:"center"}],we=({tickets:s})=>{const e=F({defaultOrderBy:"orderId",defaultRowsPerPage:5}),[p,h]=g.useState(s),a=z({name:"",status:"all",startDate:null,endDate:null});g.useEffect(()=>{h(s)},[s]);const l=$(a.state.startDate,a.state.endDate),i=ee({inputData:p,comparator:D(e.order,e.orderBy),filters:a.state,dateError:l});J(i,e.page,e.rowsPerPage);const d=!!a.state.name||a.state.status!=="all"||!!a.state.startDate&&!!a.state.endDate;!i.length&&d||i.length;const[c,t]=g.useState("all"),n=g.useCallback(o=>{e.onResetPage(),a.setState({name:o.target.value})},[a,e]),b=g.useCallback(o=>{e.onResetPage(),a.setState({status:o.target.value}),t(o.target.value)},[a,e]);return r.jsxs(u,{display:"flex",flexDirection:"column",alignItems:"center",sx:{borderRadius:1,height:1,width:1,overflow:"hidden",border:o=>`solid 1px ${o.vars.palette.divider}`},children:[r.jsxs(R,{spacing:2,justifyContent:{xs:"space-between"},alignItems:{xs:"flex-end",md:"center"},direction:{xs:"column",md:"row"},sx:{p:1,width:1},children:[r.jsx(N,{value:a.state.name,onChange:n,size:"small",placeholder:"Search ticket",InputProps:{startAdornment:r.jsx(Z,{position:"start",children:r.jsx(y,{icon:"eva:search-fill",sx:{color:"text.disabled"}})})}}),r.jsxs(X,{size:"small",sx:{width:200,textTransform:"capitalize"},value:c,onChange:b,children:[r.jsx(C,{value:"all",children:"All Tickets"}),r.jsx(C,{value:"Open",children:"Open Tickets"}),r.jsx(C,{value:"Closed",children:"Close Tickets"})]})]}),r.jsx(u,{sx:{flex:1,width:1},children:r.jsxs(E,{size:"small",children:[r.jsx(H,{headLabel:q}),r.jsx(I,{children:i.slice(e.page*e.rowsPerPage,e.page*e.rowsPerPage+e.rowsPerPage).map((o,x)=>r.jsxs(B,{children:[r.jsxs(w,{align:"center",children:[" ",x+1||o.id," "]}),r.jsx(w,{children:o.topic}),r.jsx(w,{align:"center",children:A(o.createTime)}),r.jsx(w,{align:"center",children:r.jsx(P,{variant:"soft",color:o.status==="Open"&&"info"||o.status==="Closed"&&"default"||"default",children:o.status})}),r.jsx(w,{align:"center",children:r.jsx(P,{variant:"soft",color:o.priority==="Low"&&"success"||o.priority==="Medium"&&"warning"||o.priority==="Hight"&&"error"||"default",children:o.priority})})]},`${o.id}`))})]})}),r.jsx(O,{sx:{width:1},page:e.page,dense:!0,count:i.length,rowsPerPage:e.rowsPerPage,onPageChange:e.onChangePage,onRowsPerPageChange:e.onChangeRowsPerPage})]})};function ee({inputData:s,comparator:e,filters:p,dateError:h}){const{status:a,name:l,startDate:i,endDate:d}=p,c=s.map((t,n)=>[t,n]);return c.sort((t,n)=>{const b=e(t[0],n[0]);return b!==0?b:t[1]-n[1]}),s=c.map(t=>t[0]),l&&(s=s.filter(t=>t.id.toString().toLowerCase().indexOf(l.toLowerCase())!==-1||t.topic.toLowerCase().indexOf(l.toLowerCase())!==-1||t.description.toLowerCase().indexOf(l.toLowerCase())!==-1)),a!=="all"&&(s=s.filter(t=>t.status===a)),h||i&&d&&(s=s.filter(t=>M(t.createdAt,i,d))),s}const te=[{id:"#",label:"#",width:40,align:"center"},{id:"title",label:"Title"},{id:"rate",label:"Date",width:180,align:"center"},{id:"totalAmount",label:"Status",width:80,align:"center"}],me=({reminders:s=[]})=>{const e=F({defaultOrderBy:"orderId",defaultRowsPerPage:5}),[p,h]=g.useState(s);g.useEffect(()=>{h(s)},[s]);const a=z({name:"",status:"all",startDate:null,endDate:null}),l=$(a.state.startDate,a.state.endDate),i=re({inputData:p,comparator:D(e.order,e.orderBy),filters:a.state,dateError:l}),d=!!a.state.name||a.state.status!=="all"||!!a.state.startDate&&!!a.state.endDate;!i.length&&d||i.length;const c=g.useCallback(t=>{e.onResetPage(),a.setState({name:t.target.value})},[a,e]);return r.jsxs(u,{display:"flex",flexDirection:"column",alignItems:"center",sx:{borderRadius:1,height:1,width:1,overflow:"hidden",border:t=>`solid 1px ${t.vars.palette.divider}`},children:[r.jsx(R,{spacing:2,justifyContent:{xs:"space-between"},alignItems:{xs:"flex-end",md:"center"},direction:{xs:"column",md:"row"},sx:{p:1,width:1},children:r.jsx(N,{value:a.state.name,onChange:c,size:"small",placeholder:"Search reminder",InputProps:{startAdornment:r.jsx(Z,{position:"start",children:r.jsx(y,{icon:"eva:search-fill",sx:{color:"text.disabled"}})})}})}),r.jsx(u,{sx:{flex:1,width:1},children:r.jsxs(E,{size:"small",children:[r.jsx(H,{headLabel:te}),r.jsxs(I,{children:[i.slice(e.page*e.rowsPerPage,e.page*e.rowsPerPage+e.rowsPerPage).map((t,n)=>r.jsxs(B,{children:[r.jsxs(w,{align:"center",children:[" ",n+1||t.id," "]}),r.jsx(w,{children:t.title}),r.jsx(w,{align:"center",children:A(t.reminderDate)}),r.jsx(w,{align:"center",children:r.jsx(P,{variant:"soft",color:v(t.reminderDate)?"error":"success",children:r.jsx(y,{icon:v(t.reminderDate)?"solar:forbidden-circle-bold":"solar:check-circle-bold-duotone",sx:{color:v(t.reminderDate)?"error":"success"}})})})]},`${t.id}`)),r.jsx(W,{emptyRows:K(e.page,e.rowsPerPage,i.length)})]})]})}),r.jsx(O,{sx:{width:1},page:e.page,dense:!0,count:i.length,rowsPerPage:e.rowsPerPage,onPageChange:e.onChangePage,onRowsPerPageChange:e.onChangeRowsPerPage})]})};function re({inputData:s,comparator:e,filters:p,dateError:h}){const{status:a,name:l,startDate:i,endDate:d}=p,c=s.map((t,n)=>[t,n]);return c.sort((t,n)=>{const b=e(t[0],n[0]);return b!==0?b:t[1]-n[1]}),s=c.map(t=>t[0]),l&&(s=s.filter(t=>t.id.toString().toLowerCase().indexOf(l.toLowerCase())!==-1||t.title.toLowerCase().indexOf(l.toLowerCase())!==-1||t.description.toLowerCase().indexOf(l.toLowerCase())!==-1)),a!=="all"&&(s=s.filter(t=>t.status===a)),h||i&&d&&(s=s.filter(t=>M(t.createdAt,i,d))),s}const fe=({quotation:s})=>{const[e,p]=g.useState(),h=()=>{const l=window.open("","_blank");p(l)},{user:a}=Q();return g.useEffect(()=>{const i=ae((d=>{var t;let c=d.userOwnedApps;return(t=a==null?void 0:a.roles)!=null&&t.includes("STAFF")&&(c=d.applications),c})(a),s);e==null||e.document.open(),e==null||e.document.write(i),e==null||e.document.close(),e==null||e.print()},[e]),r.jsx(V,{onClick:h,children:r.jsx(y,{icon:"solar:printer-minimalistic-bold",color:"grey.800"})})},ae=(s,e)=>{var p,h,a,l,i,d,c,t,n,b,o,x,k,j,L,T;return`
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="py-4">
          ...
          <tbody>
            <tr>
              <td class="w-full align-top" style="position: relative">
                ...
                >
                  <img
                    src="${U.site.serverFileHost}${s.appLogo}"
                    class="h-12"
            ...
            <tr>
              ...
              <td class="w-1/2 align-top text-right">
                <div class="text-sm text-neutral-600">
                  ...
                  <p>${(o=(b=e.customer)==null?void 0:b.address)==null?void 0:o.street}</p>
      ...
      <div class="px-14 py-10 text-sm text-neutral-700">
        <table class="w-full border-collapse border-spacing-0">
          ...
          <tbody>
            ${(j=e.productToQuotation)==null?void 0:j.map((m,S)=>`
            <tr ${S%2!==0&&'class="tr-background-color"'}>
              <td class="border-b py-3 pl-3">${S}.</td>
                        ...
                        <table class="w-full border-collapse border-spacing-0">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="p-3 text-right">
                                <div class="whitespace-nowrap font-bold">
                                ${e!=null&&e.snapshotTaxPercentage?f(Y((e==null?void 0:e.totalAmount)-(e==null?void 0:e.totalAmount)*((e==null?void 0:e.discount)/100),e==null?void 0:e.snapshotTaxPercentage),s.currencySymbol):"-"}
                                </div>
                              </td>
                            </tr>
                            <tr class="tr-background-color">
                              ...
                              <td class="p-3 text-right">
                                ...
                                >
                                ${f(G((e==null?void 0:e.totalAmount)-(e==null?void 0:e.totalAmount)*((e==null?void 0:e.discount)/100),e==null?void 0:e.snapshotTaxPercentage),s.currencySymbol)||"-"}
                                </div>
                              </td>
                            </tr>
                          </tbody>
              ...
              <td  class="px-14" style="display: flex; justify-content: right;">
                <div class="text-sm text-neutral-600" >
                  <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <p class="font-bold">${(L=e==null?void 0:e.application)==null?void 0:L.email}</p>
                  </div>
                  <div class="pt-3" style="display: flex; align-items: center; gap: 10px;">
                    <span><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p class="font-bold"><span></span> ${(T=e==null?void 0:e.application)==null?void 0:T.phoneNumber}</p>
                  </div>
                </div>
              </td>
            </tr>
...
`};export{fe as P,we as Q,me as a};
