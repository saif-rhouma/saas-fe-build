import{br as Q,r as g,df as _,e3 as U,j as t,B as C,S as Y,I as v,a7 as P,d1 as G,d8 as T,ed as X,ee as k,X as le,$ as ie,C as oe,ab as de,ea as ne,e8 as ce}from"./index-BrVky5Gg.js";import{g as J,r as pe,e as be}from"./utils-MBUcMVfY.js";import{u as K}from"./use-table-DPRJgMt8.js";import{a as W,b as q,c as ee,T as te}from"./table-head-custom-CKQJMo0x.js";import{T as ae}from"./table-pagination-custom-DhUmgRwP.js";import{T as re}from"./TextField-BzhmS018.js";import{I as se}from"./InputAdornment-DEzDbK1Q.js";import{S as he}from"./Select-6IXk9lW0.js";import{T as m}from"./TableCell-VebxIpQE.js";import{T as ge}from"./table-empty-rows-B-BeiqOV.js";import{b as x}from"./format-number-BYcftzxu.js";const Se=({tickets:r})=>{const e=K({defaultOrderBy:"orderId",defaultRowsPerPage:5}),{t:c}=Q("quotations"),[h,n]=g.useState(r),s=_({name:"",status:"all",startDate:null,endDate:null}),l=[{id:"orderNumber",label:"#",width:40,align:"center"},{id:"name",label:`${c("detailView.tickets.table.tableHeader.topic")}`},{id:"rate",label:`${c("detailView.tickets.table.tableHeader.date")}`,width:200,align:"center"},{id:"totalAmount",label:`${c("detailView.tickets.table.tableHeader.status")}`,width:80,align:"center"},{id:"status",label:`${c("detailView.tickets.table.tableHeader.priority")}`,width:120,align:"center"}];g.useEffect(()=>{n(r)},[r]);const b=U(s.state.startDate,s.state.endDate),i=me({inputData:h,comparator:J(e.order,e.orderBy),filters:s.state,dateError:b});pe(i,e.page,e.rowsPerPage);const a=!!s.state.name||s.state.status!=="all"||!!s.state.startDate&&!!s.state.endDate;!i.length&&a||i.length;const[p,o]=g.useState("all"),f=g.useCallback(d=>{e.onResetPage(),s.setState({name:d.target.value})},[s,e]),u=g.useCallback(d=>{e.onResetPage(),s.setState({status:d.target.value}),o(d.target.value)},[s,e]);return t.jsxs(C,{display:"flex",flexDirection:"column",alignItems:"center",sx:{borderRadius:1,height:1,width:1,overflow:"hidden",border:d=>`solid 1px ${d.vars.palette.divider}`},children:[t.jsxs(Y,{spacing:2,justifyContent:{xs:"space-between"},alignItems:{xs:"flex-end",md:"center"},direction:{xs:"column",md:"row"},sx:{p:1,width:1},children:[t.jsx(re,{value:s.state.name,onChange:f,size:"small",placeholder:c("detailView.tickets.table.tableToolbar.searchPlaceholder"),InputProps:{startAdornment:t.jsx(se,{position:"start",children:t.jsx(v,{icon:"eva:search-fill",sx:{color:"text.disabled"}})})}}),t.jsxs(he,{size:"small",sx:{width:200,textTransform:"capitalize"},value:p,onChange:u,children:[t.jsx(P,{value:"all",children:c("detailView.tickets.table.tableToolbar.selectMenu.allTickets")}),t.jsx(P,{value:"Open",children:c("detailView.tickets.table.tableToolbar.selectMenu.openTickets")}),t.jsx(P,{value:"Closed",children:c("detailView.tickets.table.tableToolbar.selectMenu.closeTickets")})]})]}),t.jsx(C,{sx:{flex:1,width:1},children:t.jsxs(W,{size:"small",children:[t.jsx(q,{headLabel:l}),t.jsx(ee,{children:i.slice(e.page*e.rowsPerPage,e.page*e.rowsPerPage+e.rowsPerPage).map((d,y)=>t.jsxs(te,{children:[t.jsxs(m,{align:"center",children:[" ",y+1||d.id," "]}),t.jsx(m,{children:d.topic}),t.jsx(m,{align:"center",children:G(d.createTime)}),t.jsx(m,{align:"center",children:t.jsx(T,{variant:"soft",color:d.status==="Open"&&"info"||d.status==="Closed"&&"default"||"default",children:d.status})}),t.jsx(m,{align:"center",children:t.jsx(T,{variant:"soft",color:d.priority==="Low"&&"success"||d.priority==="Medium"&&"warning"||d.priority==="Hight"&&"error"||"default",children:d.priority})})]},`${d.id}`))})]})}),t.jsx(ae,{sx:{width:1},page:e.page,dense:!0,count:i.length,rowsPerPage:e.rowsPerPage,onPageChange:e.onChangePage,onRowsPerPageChange:e.onChangeRowsPerPage})]})};function me({inputData:r,comparator:e,filters:c,dateError:h}){const{status:n,name:s,startDate:l,endDate:b}=c,i=r.map((a,p)=>[a,p]);return i.sort((a,p)=>{const o=e(a[0],p[0]);return o!==0?o:a[1]-p[1]}),r=i.map(a=>a[0]),s&&(r=r.filter(a=>a.id.toString().toLowerCase().indexOf(s.toLowerCase())!==-1||a.topic.toLowerCase().indexOf(s.toLowerCase())!==-1||a.description.toLowerCase().indexOf(s.toLowerCase())!==-1)),n!=="all"&&(r=r.filter(a=>a.status===n)),h||l&&b&&(r=r.filter(a=>X(a.createdAt,l,b))),r}const ze=({reminders:r=[]})=>{const e=K({defaultOrderBy:"orderId",defaultRowsPerPage:5}),[c,h]=g.useState(r),{t:n}=Q("quotations"),s=[{id:"#",label:"#",width:40,align:"center"},{id:"title",label:`${n("detailView.reminders.table.tableHeader.title")}`},{id:"rate",label:`${n("detailView.reminders.table.tableHeader.date")}`,width:180,align:"center"},{id:"totalAmount",label:`${n("detailView.reminders.table.tableHeader.status")}`,width:80,align:"center"}];g.useEffect(()=>{h(r)},[r]);const l=_({name:"",status:"all",startDate:null,endDate:null}),b=U(l.state.startDate,l.state.endDate),i=we({inputData:c,comparator:J(e.order,e.orderBy),filters:l.state,dateError:b}),a=!!l.state.name||l.state.status!=="all"||!!l.state.startDate&&!!l.state.endDate;!i.length&&a||i.length;const p=g.useCallback(o=>{e.onResetPage(),l.setState({name:o.target.value})},[l,e]);return t.jsxs(C,{display:"flex",flexDirection:"column",alignItems:"center",sx:{borderRadius:1,height:1,width:1,overflow:"hidden",border:o=>`solid 1px ${o.vars.palette.divider}`},children:[t.jsx(Y,{spacing:2,justifyContent:{xs:"space-between"},alignItems:{xs:"flex-end",md:"center"},direction:{xs:"column",md:"row"},sx:{p:1,width:1},children:t.jsx(re,{value:l.state.name,onChange:p,size:"small",placeholder:n("detailView.reminders.table.tableToolbar.searchPlaceholder"),InputProps:{startAdornment:t.jsx(se,{position:"start",children:t.jsx(v,{icon:"eva:search-fill",sx:{color:"text.disabled"}})})}})}),t.jsx(C,{sx:{flex:1,width:1},children:t.jsxs(W,{size:"small",children:[t.jsx(q,{headLabel:s}),t.jsxs(ee,{children:[i.slice(e.page*e.rowsPerPage,e.page*e.rowsPerPage+e.rowsPerPage).map((o,f)=>t.jsxs(te,{children:[t.jsxs(m,{align:"center",children:[" ",f+1||o.id," "]}),t.jsx(m,{children:o.title}),t.jsx(m,{align:"center",children:G(o.reminderDate)}),t.jsx(m,{align:"center",children:t.jsx(T,{variant:"soft",color:k(o.reminderDate)?"error":"success",children:t.jsx(v,{icon:k(o.reminderDate)?"solar:forbidden-circle-bold":"solar:check-circle-bold-duotone",sx:{color:k(o.reminderDate)?"error":"success"}})})})]},`${o.id}`)),t.jsx(ge,{emptyRows:be(e.page,e.rowsPerPage,i.length)})]})]})}),t.jsx(ae,{sx:{width:1},page:e.page,dense:!0,count:i.length,rowsPerPage:e.rowsPerPage,onPageChange:e.onChangePage,onRowsPerPageChange:e.onChangeRowsPerPage})]})};function we({inputData:r,comparator:e,filters:c,dateError:h}){const{status:n,name:s,startDate:l,endDate:b}=c,i=r.map((a,p)=>[a,p]);return i.sort((a,p)=>{const o=e(a[0],p[0]);return o!==0?o:a[1]-p[1]}),r=i.map(a=>a[0]),s&&(r=r.filter(a=>a.id.toString().toLowerCase().indexOf(s.toLowerCase())!==-1||a.title.toLowerCase().indexOf(s.toLowerCase())!==-1||a.description.toLowerCase().indexOf(s.toLowerCase())!==-1)),n!=="all"&&(r=r.filter(a=>a.status===n)),h||l&&b&&(r=r.filter(a=>X(a.createdAt,l,b))),r}const Me=({quotation:r})=>{const[e,c]=g.useState(),h=()=>{const s=window.open("","_blank");c(s)},{user:n}=le();return g.useEffect(()=>{const l=fe((b=>{var a;let i=b.userOwnedApps;return(a=n==null?void 0:n.roles)!=null&&a.includes("STAFF")&&(i=b.applications),i})(n),r);e==null||e.document.open(),e==null||e.document.write(l),e==null||e.document.close(),e==null||e.print()},[e]),t.jsx(ie,{onClick:h,children:t.jsx(v,{icon:"solar:printer-minimalistic-bold",color:"grey.800"})})},fe=(r,e)=>{var c,h,n,s,l,b,i,a,p,o,f,u,d,y,j,$,L,S,z,M,R,A,H,D,F,E,I,N,B,V,O;return`
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
*/
  ...
  <body>
    ...
    <div class="py-4" style="margin-top:20px">
          ...
          <tbody>
            <tr>
              <td class="w-full align-top" style="position: relative">
                ...
                >
                  <img
                    src="${oe.site.serverFileHost}${r.appLogo}"
                    class="h-12"
                      ...
                      <tr>
                        <td class="border-r pr-5">
                          <div>
                            ...
                            ${de(e.quotationDate).format("MMMM DD, YYYY")}
                            </p>
                          </div>
                        </td>
                        <td class="pl-5">
            ...
            <tr>
              <td class="w-1/2 align-top">
                <div class="text-sm text-neutral-600">
                  ...
                  <p>${(p=(a=e.application)==null?void 0:a.address)==null?void 0:p.country}</p>
                </div>
              </td>
      ...
      <div class="px-14 py-10 text-sm text-neutral-700">
        <table class="w-full border-collapse border-spacing-0">
          ...
          <tbody>
            ${(y=e.productToQuotation)==null?void 0:y.map((w,Z)=>`
            <tr ${Z%2!==0&&'class="tr-background-color"'}>
              ...
              <td class="border-b py-3 pl-2 text-right">
                ${x(w.snapshotProductPrice||w.product.price,r.currencySymbol)}
              </td>
              <td class="border-b py-3 pl-2 text-center">
                ${w==null?void 0:w.quantity}
              </td>
              <td class="border-b py-3 pl-2 text-center">
                ${x(w.snapshotProductPrice*w.quantity,r.currencySymbol)}
              </td>
            </tr>
            `)}
            <tr>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="border-b p-3 text-right">
                                ...
                                ${x(e==null?void 0:e.totalAmount,r.currencySymbol)}
                                </div>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td class="p-3 text-right">
                                <div class="whitespace-nowrap font-bold">
                                ${e!=null&&e.snapshotTaxPercentage?x(ne((e==null?void 0:e.totalAmount)-(e==null?void 0:e.totalAmount)*((e==null?void 0:e.discount)/100),e==null?void 0:e.snapshotTaxPercentage),r.currencySymbol):"-"}
                                </div>
                              </td>
                            </tr>
                            <tr class="tr-background-color">
                              ...
                              <td class="p-3 text-right">
                                ...
                                >
                                ${x(ce((e==null?void 0:e.totalAmount)-(e==null?void 0:e.totalAmount)*((e==null?void 0:e.discount)/100),e==null?void 0:e.snapshotTaxPercentage),r.currencySymbol)||"-"}
                                </div>
                              </td>
                            </tr>
                          </tbody>
    ...
    <div>
      <div class="${((j=e.productToQuotation)==null?void 0:j.length)>8&&"conditional-section"} text-sm">
      ${(($=e.productToQuotation)==null?void 0:$.length)>8?` <div class="px-14 py-6 text-sm">
        <table class="w-full border-collapse border-spacing-0">
          <tbody>
            <tr>
              <td class="w-1/2 align-top">
                <div class="text-sm text-neutral-600">
                  ...
                  <p>${(R=(M=e.application)==null?void 0:M.address)==null?void 0:R.city}</p>
                  <p>${(H=(A=e.application)==null?void 0:A.address)==null?void 0:H.state}</p>
                  <p>${(F=(D=e.application)==null?void 0:D.address)==null?void 0:F.country}</p>
                </div>
              </td>
              <td class="w-1/2 align-top text-right">
                <div class="text-sm text-neutral-600">
              ...
              <td  class="px-14" style="display: flex; justify-content: right;">
                <div class="text-sm text-neutral-600" >
                  <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <p class="font-bold">${(V=e==null?void 0:e.application)==null?void 0:V.email}</p>
                  </div>
                  <div class="pt-3" style="display: flex; align-items: center; gap: 10px;">
                    <span><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <p class="font-bold"><span></span> ${(O=e==null?void 0:e.application)==null?void 0:O.phoneNumber}</p>
                  </div>
                </div>
              </td>
            </tr>
...
`};export{Me as P,Se as Q,ze as a};
