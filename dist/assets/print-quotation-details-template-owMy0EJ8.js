...
*/
  ...
  <body>
    ...
    <div>
      <div class="${((L=e.productToQuotation)==null?void 0:L.length)>8&&"conditional-section"} py-6 text-sm">
        <table class="w-full border-collapse border-spacing-0">
          <tbody>
            <tr>
              <td class="w-1/2 align-top">
