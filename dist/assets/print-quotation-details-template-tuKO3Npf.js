        ...
        <tr>
          <td class="w-full align-top" style="position : relative">
            <div style="display: flex; gap:20px; align-items: center;object-fit: contain; position : absolute ;width: 100%; height: 100%">
              <img src="${q.site.serverFileHost}${s.appLogo}" class="h-12" style="height: 100%; object-fit: contain;" />
              <!-- <span class="font-bold text-main" style="width: 100%;font-size:24px">${s.name}</span> -->
            </div>
          </td>
