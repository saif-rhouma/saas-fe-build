        ...
        <tr>
          <td class="w-full align-top">
            <div style="display: flex; gap:20px; align-items: center">
              <img src="${I.site.serverFileHost}${s.appLogo}" class="h-12" />
                  ...
                  <tr>
                    <td class="border-r pr-4">
                      <div>
                        ...
                        <p class="whitespace-nowrap font-bold text-main text-right">${tt().format("MMMM DD, YYYY")}</p>
                      </div>
                    </td>
                    <td class="pl-4">
                      <div>
...
`},ht=z.object({status:z.string().min(1,{message:"Status is required!"})}),Dt=({currentOrder:s,open:t,onClose:b,handler:w})=>{const o=A.useMemo(()=>({status:(s==null?void 0:s.status)||""}),[s]);A.useEffect(()=>{x(o)},[s]);const r=M(),{mutate:h}=Q({mutationFn:({id:d,payload:u})=>E.patch(L.orderStatus.edit+d,u),onSuccess:async()=>{await r.invalidateQueries({queryKey:["orders"]}),await r.invalidateQueries({queryKey:["order",s.id]}),await r.invalidateQueries({queryKey:["orders","analytics"]})},onSettled:async()=>{},onError:d=>{console.log(d)}}),l=G({resolver:U(ht),defaultValues:o}),{reset:x,watch:f,setValue:S,handleSubmit:j,formState:{isSubmitting:T}}=l,v=j(async d=>{try{await h({id:s.id,payload:d}),b()}catch(u){console.error(u)}});return e.jsxs(V,{fullWidth:!0,open:t,onClose:b,children:[e.jsx(K,{children:"Order Status"}),e.jsx(F,{}),e.jsxs(H,{methods:l,onSubmit:v,children:[e.jsx(W,{sx:{pt:1,mt:1,display:"flex",justifyContent:"center"},children:e.jsx($.RadioGroup,{row:!0,name:"status",options:[{label:e.jsxs(m,{sx:{display:"flex",justifyContent:"center",gap:1},children:[e.jsx(O,{icon:"solar:double-alt-arrow-right-bold-duotone",sx:{color:"error.main"}}),"Processing"]}),value:"InProcess"},{label:e.jsxs(m,{sx:{display:"flex",justifyContent:"center",gap:1},children:[e.jsx(O,{icon:"solar:double-alt-arrow-right-bold-duotone",sx:{color:"warning.main"}}),"Ready"]}),value:"Ready"},{label:e.jsxs(m,{sx:{display:"flex",justifyContent:"center",gap:1},children:[e.jsx(O,{icon:"solar:double-alt-arrow-up-bold-duotone",sx:{color:"info.main"}}),"Delivered"]}),value:"Delivered"}],sx:{gap:6,flexGrow:1}})}),e.jsxs(Y,{children:[e.jsx(B,{type:"submit",variant:"contained",children:"Confirm"}),e.jsx(B,{color:"inherit",variant:"outlined",onClick:b,children:"Cancel"})]})]})]})};export{At as O,Tt as P,Ct as a,Dt as b};
